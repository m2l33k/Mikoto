...
export class Ran {
  ...
  protected readonly cells: Cell[] = [
    { cell: 'Cell-01', pci: 101, tac: '0x1A2B', band: 'n78 (3.5GHz)', ues: 1, prb: 61, rsrp: -84, status: 'up' },
    { cell: 'Cell-02', pci: 102, tac: '0x1A2B', band: 'n78 (3.5GHz)', ues: 1, prb: 54, rsrp: -91, status: 'up' },
    { cell: 'Cell-03', pci: 103, tac: '0x1A2C', band: 'n258 (mmWave)', ues: 0, prb: 38, rsrp: -97, status: 'up' },
    { cell: 'Cell-04', pci: 104, tac: '0x1A2C', band: 'n78 (3.5GHz)', ues: 0, prb: 96, rsrp: -88, status: 'congested' },
    { cell: 'Cell-05', pci: 105, tac: '0x1A2D', band: 'n41 (2.5GHz)', ues: 0, prb: 21, rsrp: -102, status: 'down' },
  ];
