  ...
  protected readonly events: Event[] = [
    {
      ...
      severity: 'critical',
      source: 'ML-Engine',
      message: 'IMSI Catcher signature detected — src 192.168.12.9',
    },
    {
      time: '13:58:40',
      severity: 'warning',
      source: 'UPF-Node-01',
      message: 'CPU saturation 76% sustained over 5m window',
    },
    {
      time: '13:47:02',
      severity: 'warning',
      source: 'PKI',
      message: 'AMF certificate enters renewal window (48h)',
    },
    {
      time: '13:31:55',
      severity: 'info',
      source: 'NRF',
      message: 'NF profile registered: SMF-Node-02 (nsmf-pdusession)',
    },
    {
      time: '13:20:18',
      severity: 'info',
      source: 'Vault',
      message: 'Dynamic DB credential leased to UDM (ttl 1h)',
    },
  ];
}
